...
We found that the fourth model (model4_log) including the 'feedlevel', 'sla', 'chlorophyll', 'num_lvs' and 'num_phylls' predictors best predicted total biomass in Sarracenia. We backtransformed the estimates back to exponential (not log) to report it on the scale of the original variables and as shown in the table below, model 4 is statistically significant.
